...
<header id="head">
	...
	<button class="button011" name="username" value=<%= username %>></button>		
...
<form method="post" action="./logedinproduct">
  <p><input class="label1" type="checkbox" name="product" value="1" /></p>
  <p><input class="label2" type="checkbox" name="product" value="2" /></p>
  <p><input class="label3" type="checkbox" name="product" value="3" /></p>
  <p><input class="label4" type="checkbox" name="product" value="4" /></p>
  <p><input class="label5" type="checkbox" name="product" value="5" /></p>
  <p><input class="label6" type="checkbox" name="product" value="6" /></p>
  <p><input class="label7" type="checkbox" name="product" value="7" /></p>
  <p><input class="label8" type="checkbox" name="product" value="8" /></p>
  <p><input class="label9" type="checkbox" name="product" value="9" /></p>
  <p><input class="label10" type="checkbox" name="product" value="10" /></p>
...
<form method="post" action="./logedinproduct">
    ...
    <button name="commodityID" class="detail1" type = "sumbit" value="1" formtarget="_blank"></button>
	</form>
    </a>
	<form method="post" action="./logedinproduct">
	<a href="loginproductdetail.jsp">
    <button name="commodityID" class="detail2" type = "sumbit" value="2" ></button>
	</a>
	</form>
	<form method="post" action="./logedinproduct">
	<a href="loginproductdetail.jsp">
    <button name="commodityID" class="detail3" type = "sumbit" value="3" ></button>
	</a>
	</form>
	<form method="post" action="./logedinproduct">
	<a href="loginproductdetail.jsp">
    <button name="commodityID" class="detail4" type = "sumbit" value="4" ></button>
	</a>
	</form>
	<form method="post" action="./logedinproduct">
	<a href="loginproductdetail.jsp">
    <button name="commodityID" class="detail5" type = "sumbit" value="5" ></button>
	</a>
	</form>
	<form method="post" action="./logedinproduct">
	<a href="loginproductdetail.jsp">
    <button name="commodityID" class="detail6" type = "sumbit" value="6" ></button>
	</a>
	</form>
	<form method="post" action="./logedinproduct">
	<a href="loginproductdetail.jsp">
    <button name="commodityID" class="detail7" type = "sumbit" value="7" ></button>
	</a>
	</form>
	<form method="post" action="./logedinproduct">
	<a href="loginproductdetail.jsp">
    <button name="commodityID" class="detail8" type = "sumbit" value="8" ></button>
	</a>
	</form>
	<form method="post" action="./logedinproduct">
	<a href="loginproductdetail.jsp">
    <button name="commodityID" class="detail9" type = "sumbit" value="9" ></button>
	</a>
	</form>
	<form method="post" action="./logedinproduct">
	<a href="loginproductdetail.jsp">
    <button name="commodityID" class="detail10" type = "sumbit" value="10" ></button>
	</a>
	</form>	
